...
\definecolor{accent}{HTML}{0C7A88}
\definecolor{warm}{HTML}{B96A1A}
\definecolor{inksoft}{HTML}{51636A}
...
\title{\vspace{-1.5em}\textbf{\color{accent} Fast-Forwarding the Degenerate Case}\\[0.3em]
\large A Verification-First Quantum Algorithm for the\\ 2D Convecting Taylor--Green Vortex}
\author{Assal Mouadh Abderrahmane \and Boussahi Achraf \and Chekroun Abir \and Lourghi Zakaria \and Menacer Hiba \\[0.3em] \normalsize AiQC --- AI \& Quantum Community}
\date{\small Submitted to the 2026 Global Quantum + AI Challenge \textbar\ Airbus Track}
